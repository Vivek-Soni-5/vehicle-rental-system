...
<body>
    ...
    <div class="dropdown">
        ...
        <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="/covid/provide_vehicle.php">Add a Vehicle</a></li>
            <li><a class="dropdown-item" href="/covid/added_vehicles.php">provided vehicles</a></li>
