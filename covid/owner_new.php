...
<body>
    ...
    <header class="text-gray-600 body-font" style="color:blue; background-color:red;">
        ...
        " aria-labelledby="dropdownMenuButton1">
              ...
              text-gray-700
              hover:bg-gray-100
            " href="/covid/provide_vehicle.php">Add a Vehicle</a>
                                </li>
                                <li>
                                    <a class="
              dropdown-item
              ...
              text-gray-700
              hover:bg-gray-100
            " href="/covid/added_vehicles.php">provided vehicless</a>
                                </li>
                                <li>
                                <li>
                                    <a class="
              ...
              text-gray-700
              hover:bg-gray-100
            " href="/covid/owner_booked_vehicle.php">your booked vehicles</a>
                                </li>
                                <li>
                                    <a class="
              dropdown-item
    ...
    <div class="flex"
        ...
        <div class="flex justify-center">
            <div class="rounded-lg shadow-lg bg-white max-w-sm">
                <a href="\covid\provide_vehicle.php">
                    <img class="rounded-t-lg" src="http://localhost/covid/add_vehicle.jpg" alt="" />
                </a>
        ...
        <div class="flex justify-center">
            <div class="rounded-lg shadow-lg bg-white max-w-sm">
                <a href="\covid\added_vehicles.php">
                    <img class="rounded-t-lg" src="http://localhost/covid/added_vehicles.png" alt="" />
                </a>
                <div class="p-6" style = "display: flex;justify-content: center;" >
                    <!-- <h5 class="text-gray-900 text-xl font-medium mb-2">Card title</h5> -->
                    <!-- <p class="text-gray-700 text-base mb-4">
                    ...
                    <a href="\covid\added_vehicles.php">
                    <button type="button"
                        class=" inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out" style = "border-radius: 50px;background: orangered;">Your Added Vehicle</button>
                    </a>
                    </div>
            </div>
        </div>
        ...
        <div class="flex justify-center">
            <div class="rounded-lg shadow-lg bg-white max-w-sm">
                <a href="\covid\owner_booked_vehicle.php">
                    <img class="rounded-t-lg" src="http://localhost/covid/booked_vehicle.jpg" alt="" />
                </a>
                <div class="p-6" style = "display: flex;justify-content: center;" >
                    <!-- <h5 class="text-gray-900 text-xl font-medium mb-2">Card title</h5> -->
                    <!-- <p class="text-gray-700 text-base mb-4">
                    ...
                    <a href="\covid\owner_booked_vehicle.php">
                    <button type="button"
                        class=" inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out" style = "border-radius: 50px;background: orangered;">Your Booked Vehicle</button>
                    </a>
                    </div>
            </div>
        </div>
