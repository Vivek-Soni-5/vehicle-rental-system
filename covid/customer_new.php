    ...
    <header class="text-gray-600 body-font" style="color:blue; background-color:red;">
        ...
        " aria-labelledby="dropdownMenuButton1">
            ...
            " href="/covid/booking_details.php">Booking Details</a>
              ...
              text-gray-700
              hover:bg-gray-100
            " href="/covid/toBook.php">Book a Vehicle</a>
                                </li>
                                <li>
                                    <a class="
              dropdown-item
        ...
        <div class="flex justify-center">
            <div class="rounded-lg shadow-lg bg-white max-w-sm">
                <a href="\covid\booking_details.php">
                    <img class="rounded-t-lg" src="http://localhost/covid/booking_details_image.jpg" alt="" />
                </a>
        ...
        <div class="flex justify-center">
            <div class="rounded-lg shadow-lg bg-white max-w-sm">
                <a href="\covid\toBook.php">
                    <img class="rounded-t-lg" src="http://localhost/covid/book_vehicle_image.jpg" alt="" />
                </a>
                <div class="p-6" style = "display: flex;justify-content: center;" >
                    <!-- <h5 class="text-gray-900 text-xl font-medium mb-2">Card title</h5> -->
                    <!-- <p class="text-gray-700 text-base mb-4">
                    ...
                    <a href="\covid\toBook.php">
                    <button type="button"
                        class=" inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out" style = "border-radius: 50px;background: orangered;">Book Now</button>
                    </a>
                    </div>
            </div>
        </div>
